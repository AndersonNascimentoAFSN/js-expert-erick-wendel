...
describe('Test #BaseBusiness', () => {
  beforeEach(() => {
    jest.restoreAllMocks()
  })

  it('should throw an error when child class doesn\'t implement _validateRequiredFields function', () => {
  ...
  it('should throw an error when  _validateRequiredFields return false', () => {
  ...
  it('should throw an error when child class doesn\'t implement _create function', () => {
  ...
  it('should call _create and _validateRequiredFields on create', () => {
    const VALIDATION_SUCCEED = true
