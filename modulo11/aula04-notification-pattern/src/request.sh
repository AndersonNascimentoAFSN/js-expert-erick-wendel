...
curl -i localhost:3000 -X POST --data '{"name": "V", "age": "21"}' -H 'Content-Type: application/json'

echo $'\n\n[requesting: all invalid]'
curl -i localhost:3000 -X POST --data '{"name": "V", "age": "0"}' -H 'Content-Type: application/json'
